...
class ReviewDemographicsPageData {
  ...
  static expectedTitleOfReviewDemographicInSpanish =
  ...
  static popUpForInvalidEmailInSpanish =
  ...
  static errorMessageForFutureDOBInEnglish =
    "Invalid date (cannot be in the future).";
  static errorMessageForFutureDOBInSpanish =
    "Fecha no válida (no puede ser en el futuro).";
  static errorMessageForNotRealDOBInSpanish =
    "Formato no válido (no es una fecha real).";
  static errorMessageForNotRealDOBInEnglish =
    "Invalid format (not a real date).";
  static errorMessageForInvalidFormatDOBInEnglish =
    "Invalid format (not a real date).";
  static errorMessageForInvalidFormatDOBInSpanish =
    "Formato no válido (no es una fecha real).";
}
