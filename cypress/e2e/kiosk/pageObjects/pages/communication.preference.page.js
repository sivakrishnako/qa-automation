...
class CommunicationPreferencePage {
  ...
  static emailForAppointmentInfo =
    '[data-testid="email_aprem-info-email-check"] > .PrivateSwitchBase-input';
  static textHealthInformationAndAlerts =
    '[data-testid="text_heala-info-text-check"] > .PrivateSwitchBase-input';
  static emailPatientSurveys =
    '[data-testid="text_survy-info-text-check"] > .PrivateSwitchBase-input';
  static textForVisitSummaries =
    '[data-testid="text_vsumm-info-text-check"] > .PrivateSwitchBase-input';
  ...
  static PaperlessStatementsEmail =
    '[data-testid="paperless-statements-email"]';
  ...
  static buttonForDisableElectronicCommunication =
    '[data-testid="undefinedno"]';
  static receiveAppointmentInformation =
    ':nth-child(2) > .communication-title > [data-testid="appointment-info"]';
  static healthInformationAndAlerts =
    ':nth-child(3) > .communication-title > [data-testid="appointment-info"]';
  static patientSurveys =
    ':nth-child(4) > .communication-title > [data-testid="appointment-info"]';
  static visitSummaries =
    ':nth-child(5) > .communication-title > [data-testid="appointment-info"]';
  static textForAppointmentInfoInSpanish =
    '[data-testid="text_aprem-info-text-check-chip"]';
  static textForHealthInformationAndAlertsInSpanish =
    '[data-testid="text_heala-info-text-check-chip"]';
  static textForPatientSurveysInSpanish =
    '[data-testid="text_survy-info-text-check-chip"]';
  static textForVisitSummariesInSpanish =
    '[data-testid="text_vsumm-info-text-check-chip"]';
  static readAgreement = '[data-testid="read-agreement"]';
  static titleOfAgreementInSpanish =
    '.MuiPaper-root > .MuiGrid-container > .MuiGrid-grid-xs-11 > [data-testid="card-title"]';
  ...
  static phoneOptionForHealthInfo() {
    return cy.get(
      '[data-testid="phone_heala-info-email-check"] > .PrivateSwitchBase-input'
    );
  }
  static emailOptionForHealthInfo() {
    return cy.get(
      '[data-testid="email_heala-info-email-check"] > .PrivateSwitchBase-input'
    );
  }
