...
class InsurancePage {
  ...
  static noImageToDisplayMessage =
    ":nth-child(1) > .section-frame > .placeholder-card > .MuiTypography-root";
  ...
  static communicationPreferenceInSpanish =
    '[data-testid="communication_preference"]';
  static saveButtonInSpanish = '[data-testid="edit-insurance-save"]';
  static uploadCardNotificationInSpanish =
    '[data-testid="upload-your-card-notification"]';
  static clickOnUploadBackCardJs =
    "#root > div > div > div.MuiGrid-root.MuiGrid-container.insurance-container.css-1d3bbye > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.edit-section.css-k4xiad > div:nth-child(2) > div > div > svg";
  static clickNoChangeNextBtnJs =
    "#root > div > div > div.footer-button.contentToLeft > button.MuiButton-root.MuiButton-contained.MuiButton-containedPrimary.MuiButton-sizeMedium.MuiButton-containedSizeMedium.MuiButtonBase-root.alignment-button.css-1cgzx3o";
  static editInsuranceBtnJs =
    "#root > div > div > div.MuiGrid-root.MuiGrid-container.insurance-container.css-1d3bbye > div.MuiGrid-root.MuiGrid-container.MuiGrid-item.css-8x8291 > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-1.MuiGrid-grid-sm-4.MuiGrid-grid-md-4.css-blxz9b > div > button";
  static clickOnCancelBtnJs =
    "#root > div > div > div.MuiGrid-root.MuiGrid-container.insurance-container.css-1d3bbye > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.edit-section.css-k4xiad > div:nth-child(1) > div > svg > path";
  ...
  static clickSnapshot() {
    const button = cy.get(".camera-button-box > .MuiButton-root", {
      timeout: Cypress.env("elementTimeout"),
    });
    button.click();
    return this;
  ...
  static clickOnUploadSnapshot() {
    const button = cy.get(".camera-button-box > .MuiButton-contained", {
      timeout: Cypress.env("elementTimeout"),
    });
    button.click();
    return this;
  ...
  static clickOnSaveButton() {
    const button = cy.get('[data-testid="edit-insurance-save"]', {
      timeout: Cypress.env("elementTimeout"),
    });
    button.click();
    return this;
