...
static fillAmountByManually(value){
    cy.get('[data-testid="amount-payment"]').type(PaymentDetailPageData.minimumOtherAmountForCheckIn,{ timeout: 20000 }).should(PaymentDetailPageData.minimumOtherAmountForCheckIn);
    return this;
}
